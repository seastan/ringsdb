...
INSERT INTO `type` (`id`, `code`, `name`) VALUES (1,'hero','Hero'),(2,'ally','Ally'),(3,'attachment','Attachment'),(4,'event','Event'),(5,'treasure','Campaign'),(6,'player-side-quest','Player Side Quest'),(7,'contract','Other');
