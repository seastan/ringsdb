 ...
 *
 * HTML pages are compared to text snapshots stored in Tests/Resources/snapshots/pages/: the
 * visible text of the page (scripts and styles removed), one line per text node. This is strict
 * on the displayed content but not on markup or attributes (CSS classes, CSRF tokens, asset
 * URLs...), which are expected to change during the migration.
 * Downloads (text / OCTGN exports) are compared byte for byte.
 *
