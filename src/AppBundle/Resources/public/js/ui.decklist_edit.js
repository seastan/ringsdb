(function ui_decklist_edit(ui, $) {
    ...
    ui.on_button_symbol = function ui_on_button_symbol(e) {
        ...
        var icons = 'spirit tactics lore leadership neutral baggins fellowship unique threat willpower attack defense health hero ally attachment event player-side-quest player-objective contract treasure'.split(' ');
